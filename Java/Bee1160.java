...
public class CrescimentoPopulacional{
	...
	public static int AumentoPopulacao(int populacaoInicial, double crescimento){
		int resultado = (int)((populacaoInicial * crescimento) / 100);
		return resultado;
	}

	public static void main(String args[]){
		Scanner teclado;
		int testes, pA, pB, anos;
		double gA, gB;
		...
		for (int i = 1; i <= testes; i++){
			...
			while (pA <= pB){
				pA += AumentoPopulacao(pA, gA);
				pB += AumentoPopulacao(pB, gB);
				anos++;
